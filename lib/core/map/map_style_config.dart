...
/// MapLibre style + camera constants for the POI map MVP.
///
...
/// Never point a raster `TileLayer` at `https://tile.openstreetmap.org`
...
abstract final class MapStyleConfig {
  ...
  static const minZoom = 6.5;
  static const maxDefaultZoom = 7.5;
